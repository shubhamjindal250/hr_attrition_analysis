...
Corrected data types (numeric, categorical fields)

Created age bins for demographic analysis

Standardized department and role names

Prepared attrition indicators for KPI calculations
...
Attrition by Age Groups (Bins)

Overall Attrition vs Active Employees (Donut Chart)
...
Only male employees have attrited from the IT department, reflecting high market demand and job mobility in IT roles, which increases retention risk.

The IT department has the highest number of employees, making it a critical area where even small attrition rates can significantly impact operations.

Employees aged 25–29 experience the highest attrition, highlighting early-career job switching and the need for clear growth and development paths.

Overall attrition is higher among male employees, driven by their greater representation in high-turnover departments such as IT and Sales.

The Sales department records the highest attrition, likely due to performance pressure and target-driven roles, impacting revenue continuity.
